...
//!
//! Architecture: a deterministic, unit-tested library core ([`azork::oit`])
//! with this thin live driver on top. Every safety rule is enforced in code
//! via [`azork::oit::guardrails`], not merely by convention.
//!
//! Usage:
