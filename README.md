...
rooms, 2,857 resources). These screenshots reflect the adaptive room sizing,
generously spaced corridors, and dungeon decorations (border, torches,
treasure chest, dragon) introduced by the map renderer.
